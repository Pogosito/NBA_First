...
//  NBA1
//
//  Created by Погос  on 09.12.2019.
...
class Quiz: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        title = "Hall of Fame"
        let question = "Which player is pictured ?"
        ...
        myCollectionView.backgroundColor = #colorLiteral(red: 0.1764705926, green: 0.01176470611, blue: 0.5607843399, alpha: 1)
        myCollectionView.isPagingEnabled = true
        
        self.view.addSubview(myCollectionView)
        
        let que1 = Question(imgName: "1", questionText: question, options: ["Kevin Durant", "Russell Westbrook", "Kawhi Leonard", "Stephen Curry"], correctAns: 1, wrongAns: -1, isAnswered: false)
        let que2 = Question(imgName: "2", questionText: question, options: ["Anthony Davis", "Chris Paul", "Luka Dončić", "LeBron James"], correctAns: 3, wrongAns: -1, isAnswered: false)
        let que3 = Question(imgName: "3", questionText: question, options: ["Kobe Bryant", "Klay Thompson", "Derrick Rose", "Nikola Jokić"], correctAns: 2, wrongAns: -1, isAnswered: false)
        let que4 = Question(imgName: "4", questionText: question, options: ["Dirk Nowitzki", "Kemba Walker", "Joel Embiid", "Dwyane Wade"], correctAns: 3, wrongAns: -1, isAnswered: false)
        let que5 = Question(imgName: "5", questionText: question, options: ["Antetokounmpo", "Carmelo Anthony", "LaMarcus Aldridge", "Kyle Lowry"], correctAns: 0, wrongAns: -1, isAnswered: false)
        let que6 = Question(imgName: "6", questionText: question, options: ["Shaquille O'Neal", "Marc Gasol", "Michael Jordan", "Paul George"], correctAns: 2, wrongAns: -1, isAnswered: false)
        let que7 = Question(imgName: "7", questionText: question, options: ["Rudy Gobert", "James Harden", "Jimmy Butler", "Bradley Beal"], correctAns: 1, wrongAns: -1, isAnswered: false)
        let que8 = Question(imgName: "8", questionText: question, options: ["Al Horford", "Blake Griffin", "Tim Duncan", "Vince Carter"], correctAns: 3, wrongAns: -1, isAnswered: false)
        let que9 = Question(imgName: "9", questionText: question, options: ["Damian Lillard", "Kristaps Porziņģis", "DeMar DeRozan", "Kevin Love"], correctAns: 0, wrongAns: -1, isAnswered: false)
        let que10 = Question(imgName: "10", questionText: question, options: ["Ben Simmons", "Kyrie Irving", "Victor Oladipo", "Nikola Vucevic"], correctAns: 1, wrongAns: -1, isAnswered: false)
...
extension Quiz: QuizCVCellDelegate {
